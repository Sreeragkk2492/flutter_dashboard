                  ...
                  children: [
                          ...
                          child: Obx(
                            () => FormBuilderDropdown(
                              ...
                              items: employeeController.companydetails
                                  ...
                                  .toList(),
                              onChanged: (value) {
                                screenController.selectedCompanyId.value =
                                    value ?? '';
                              },
                    ...
                    Obx(() => Column(
                          children: screenController
                              .companypayrolldeduction.value.deduction
                              .map((deduction) => CheckboxListTile(
                                    title: Text(deduction.deduction),
                                    value: screenController.selecteddeductions
                                        .contains(deduction.deductionId),
                                    onChanged: (bool? value) {
                                      screenController.toggleDeduction(

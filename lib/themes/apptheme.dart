...
import 'package:flutter_dashboard/themes/app_sidebar_theme.dart';
...
class ThemeColors {
  static final lightTheme = ThemeData(
    ...
    drawerTheme: const DrawerThemeData(backgroundColor: AppColors.bgGreyColor ),
    colorScheme: const ColorScheme(
      primary: AppColors.buttonSuccessColor, 
  ...
  static final darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      primary: AppColors.buttonSuccessColor , // Customize your primary variant color
